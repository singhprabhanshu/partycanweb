              ...
              <div className="col-md-12 mb-4"><h1>Terms & Conditions</h1></div>
                  <div className="col-md-12" style={{ textAlign: "justify", textJustify: "inter-word"}}>
                      <div style={{ marginTop: 20 }}>
                        <p>
                        Welcome to DrinkPartyCan.com (“Site”), a website maintained and operated by Three Tier Solution Inc. (“Company”, “we”, “our” or “us”).
                        </p>
                      </div>
                      ...
                      <div style={{ marginTop: 20 }}>
                        ...
                        <div style={{ marginTop: 20 }}>
                            <p>
                                <span style={{ fontWeight: 'bold'}}>Questions: </span>Should you have any questions regarding these Terms and Conditions contact us at <a href="https://inquiries@DrinkPartyCan.com">inquiries@DrinkPartyCan.com.</a>
                            </p>
                        </div>
