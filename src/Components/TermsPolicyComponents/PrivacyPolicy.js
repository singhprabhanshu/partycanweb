            ...
            <React.Fragment>
              ...
              <div className="col-md-12 mb-4"><h1>Privacy Policy</h1></div>
                  <div className="col-md-12" style={{ textAlign: "justify", textJustify: "inter-word"}}>
                      <div>
                        <p>
                            Welcome to DrinkPartyCan.com (“Site”), a website maintained and operated by Three Tier Solution Inc. (“Company”, “we”, “our” or “us”). Three Tier Solution offers a white-label enterprise solution for liquor brands (“our Customers”) to enable e-commerce. Three Tier Solution’s advanced API integrates directly with our Customers’ websites, connecting our Customers with localized retailers (“Retailers”) that deliver directly to consumers (“Consumers”). Our Privacy Policy (“Privacy Policy”) is designed to help you understand how we collect, use and share your personal information and to assist you in exercising the privacy rights available to you. By using or accessing the Site, you signify your agreement to be bound by this Privacy Policy.</p>
                      </div>
                      <div>
                        <p><span style={{ fontWeight: "bold" }}>Scope: </span>
                          <span>  This Privacy Policy applies to personal information processed by us in our business, as collected on our website, from the employees of our business-to-business customers and other related online or offline offerings (collectively, the “Services”).</span>
                        </p>
                      </div>
                      <div>
                          <p><span style={{ fontWeight: "bold" }}>How it Works: </span>
                            <span>Consumers visit our Customers’ websites and provide information via the Three Tier Solution enterprise solution that is needed to fulfill e-commerce transactions for products and services. Retailers who agree to participate in Three Tier Solution’s platform will receive limited information about Consumers only as needed to deliver those products and services. This limited information includes name, address, and contact information such as phone number or email for both the purchasers and the recipient, if the purchase is intended as a gift for another person. Three Tier Solution also receives additional information from Consumers, such as product preferences, to enable Consumers to identify products or services for purchase during their shopping experience. The Three Tier Solution enterprise solution is governed by our customers’ Privacy Policies. Our Customers are responsible for providing the appropriate notice to their end-clients (Consumers) and obtaining any required authorizations to permit us to further process the personal information. We encourage you to read each of our Customer’s privacy policies in detail.</span> 
                          </p>
                      </div>
                      <div>
                          <p><span style={{ fontWeight: "bold" }}>Personal Information We Collect: </span>
                            <span>
                      ...
                      <div>
                          <span style={{ fontWeight: "bold" }}>Information Provided to Us: </span>
                          <div>
                              <p>
                               <span style={{ fontWeight: "bold" }}>User Information: </span>
                               <span> To facilitate our Services, we collect contact information such as name, date of birth, phone number, address, username, password, order history, company name, store manager contact information. In the event that the product is a gift from the individual who places the order, we collect recipient’s name, phone number and company name.</span>
                              </p>
                          </div>
                          <div>
                              <p>
                                <span style={{ fontWeight: "bold" }}>Communications with Us: </span>
                         ...
                         <div>
                             ...
                             <ul>
                                ...
                                <li>
                                    ...
                                    <span>We may also use Google Analytics and other service providers to collect information regarding visitor behavior and visitor demographics on our Services. For more information about Google Analytics, please visit <a href="www.google.com/policies/privacy/partners/">www.google.com/policies/privacy/partners/</a>. You can opt out of Google’s collection and processing of data generated by your use of the Services by going to <a href="http://tools.google.com/dlpage/gaoptout">http://tools.google.com/dlpage/gaoptout</a>.</span></p>
                                </li>
                            </ul>  
                          </div>
                          <div>
                      ...
                      <div>
                          ...
                          <div>
                            ...
                            <p>
                              If you would like to exercise any of these rights, please contact us by email at <a href="privacy@DrinkPartyCan.com">privacy@DrinkPartyCan.com</a>. If you do not want your personal information shared with any third party who may use such information for direct marketing purposes, then you may opt out of such disclosures by sending an email to us at <a href="privacy@DrinkPartyCan.com">privacy@DrinkPartyCan.com</a>. We will process such requests in accordance with applicable laws. To protect your privacy, we will take steps to verify your identity before fulfilling your request.
                            </p>
                          </div>
                          <div>
                          ...
                          <div>
                            <p><span style={{ fontWeight: "bold" }}>Contact: </span>
                                <span>For questions or concerns relating to this Privacy Policy or your information, or if you wish to submit a request to exercise your rights as detailed in this policy, please contact our Data Protection Officer by email at <a href="privacy@DrinkPartyCan.com">privacy@DrinkPartyCan.com</a>.</span>
                            </p>
                          </div>
                     </div>
                  </div>
