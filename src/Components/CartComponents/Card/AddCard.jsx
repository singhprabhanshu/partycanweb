...
const AddCard = (props) => {
  ...
  const verifyBillingInfoSuccess = (data) => {
    ...
    saveBillingInfo(billingAddress);
      ...
      setLoading(false);
      let errorMessage = _get(data,"message","something went wrong when verify the billing info");
          ...
          <Form
            ...
            render={({ handleSubmit, form }) => (
              <ReactStrapFrom id="###creditcardform###" onSubmit={handleSubmit}>
                ...
                {billingErrorMessage && <ErrorResult>{billingErrorMessage}</ErrorResult>}
