...
app.post("/api/mailchimpnewsletter/index", (req, res) => {
  console.log("--------", req.body);
  let p1 = axios.post(`${application_bff_url}/api/mailchimpnewsletter/index`, req.body);
  p1.then((apiRespo) => {
    res.setHeader('Content-Type', 'application/json');
    res.send(apiRespo.data);
  })
...
app.post("/api/customer/sociallogin", (req, res) => {
  console.log("--------", req.body);
  let p1 = axios.post(`${application_bff_url}/api/customer/sociallogin`, req.body);
  p1.then((apiRespo) => {
    res.setHeader('Content-Type', 'application/json');
    res.send(apiRespo.data);
  })
